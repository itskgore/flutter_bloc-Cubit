...
class SearchMovieCubit extends StatefulWidget {
  SearchMovieCubit({Key key}) : super(key: key);

  @override
  _SearchMovieBlocState createState() => _SearchMovieBlocState();
}

class _SearchMovieBlocState extends State<SearchMovieCubit> {
  GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  String movieName;
  void submitData(BuildContext context) async {
    if (_formKey.currentState.validate()) {
      final movieBloc = BlocProvider.of<MoviesCubit>(context, listen: false);
      _formKey.currentState.save();
      movieBloc.searchMovie(movieName);
    }
  }
